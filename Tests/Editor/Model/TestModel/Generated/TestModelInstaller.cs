...
namespace Model.TestModel
{
	...
	public partial class TestModelRepository : SingletonRepository<ITestModel, TestModelModel, TestModelReactor>
	{
		public TestModelRepository(TestModelReactorFactory presenterFactory) : base(presenterFactory)
		{ }
	}
	
	public sealed class TestModelReactorFactory : ReactorFactory<TestModelModel, TestModelReactor>
	{ }
}
